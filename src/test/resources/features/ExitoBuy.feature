Feature: I as an Exito app user
  ...
  Scenario Outline: Buy an item and sent it to juan's home
    ...
    Examples:
      ...
      | Juan      | Marica   | calle 111 # 63 B 38 | MEDELLIN   | juan.pendejo@noleimporta.com | 3112224453 | 1037111243 | borrador        |
  ...
  Scenario Outline: Buy an item and sent it to juan's local store
    ...
    When he looks for an "<item>"
    And he added it to the shopping cart
    And he finishes the checkout process sending the item to the store using his data:
      | firstName   | lastName   | eMail   | cellPhone   | id   |
      | <firstname> | <lastname> | <email> | <cellphone> | <id> |
    Then Juan must see the item added on checkout page
    Examples:
      ...
      | Juan      | Marica   | MEDELLIN   | juan.pendejo@noleimporta.com | 3112224453 | 1037111243 | borrador        |